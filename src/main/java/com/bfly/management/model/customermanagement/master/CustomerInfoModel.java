...
public class CustomerInfoModel {
    ...
    @ApiModelProperty(notes = "계약담당자 이메일주소 (개인고객일 경우 고객이메일)", example = "g9soft@gmail.com", required = true) 
    private String email;

    @ApiModelProperty(notes = "계약담당자 휴대폰 전화번호 (개인고객일 경우 고객휴대폰번호)", example = "010-5555-5566", required = true)
    private String mobile;

    @ApiModelProperty(notes = "구독페이지 로그인 아이디", example = "g9soft", required = true)
    private String loginId;

    @ApiModelProperty(notes = "구독페이지 로그인 비밀번호", example = "g9soft", required = true)
    private String loginPw;

    @ApiModelProperty(notes = "고객유형 (1:법인, 2:공공, 3:개인)  *필수", example = "3", required = true)
    private int custTp;	

    @ApiModelProperty(notes = "계약담당자 부서명  *필수(법인, 공공기관일때만)", example = "지구소프트 연구소")
    private String deptNm;	

    @ApiModelProperty(notes = "회사 우편번호 *필수(법인, 공공기관일때만)", example = "36691")
    private String postNo;	

    @ApiModelProperty(notes = "회사주소  *필수(법인, 공공기관일때만)", example = "서울시 강남구 강남중학교")
    private String address;	
    
    @ApiModelProperty(notes = "개인정보 유효기관 (탈퇴시부터 일자로 관리)  *필수", example = "365", required = true)
    private int piStoreDays;	
    
    @ApiModelProperty(notes = "회사명  *필수(법인, 공공기관일때만)", example = "지구소프트 개인")
    private String cpyNm;

    @ApiModelProperty(notes = "사업자등록번호  *필수(법인, 공공기관일때만)", example = "111-11-11111")
    private String corpRegNo;		

    @ApiModelProperty(notes = "대표자명  *필수(법인, 공공기관일때만)", example = "지구인")
    private String ceo;			
